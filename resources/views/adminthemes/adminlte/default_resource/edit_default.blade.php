        ...
        @endif
          ...
          <div class="box box-success">
            ...
            <div class="box-body default" id="default-box">
              {!!Form::open(['url'=>'/admin/default_pages/'.$default_page->id, 'method'=>'put'])!!}
              {{Form::bsText('default_table', 'Default Table', $default_page->default_table)}}
              {{Form::submit('Edit Page', ['class'=>'btn btn-info'])}}
              {!!Form::close()!!}
            </div>
            <!-- /.chat -->
